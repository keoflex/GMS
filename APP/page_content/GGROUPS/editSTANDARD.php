...
<section>
  ...
  <a class="btn btn-primary"  href="./?P=<?php echo pg_encrypt("GGROUPS-standard",$pg_encrypt_key,"encode") ?>" />Go Back to List</a>
  <hr>
  <div class="info">
    <p>&nbsp;</p>
  </div>
        ...
        <div class="panel-body">
          <div class="form-group">
            <form action="./?P=<?php echo $_GET['P']; ?>" method="post" enctype="multipart/form-data">
              <input type="hidden" id="post_type" name="post_type" value="<?php echo pg_encrypt("qrySTANDARDGROUP-editGROUP_qry",$pg_encrypt_key,"encode") ?>" />
